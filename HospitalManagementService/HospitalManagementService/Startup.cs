...
namespace HospitalManagementService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<HospitalManagementContext>(setup => setup.UseSqlServer(Configuration.GetConnectionString("connectionstring")));
            services.AddScoped<IHospitalRepository<Hospital>, HospitalRepository<Hospital>>();
            services.AddScoped<IFacilityRepository<Facility>, FacilityRepository<Facility>>();

            services.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies());
            services.AddSwaggerGen(setup => setup.SwaggerDoc("v1", new OpenApiInfo
            {
                Title = "Hospital Management API",
                Description = "Hospital Management api for Hospital Management System"
            }));
