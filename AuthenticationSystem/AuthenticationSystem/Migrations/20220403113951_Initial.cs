        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisteredHospitalId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfAvailability = table.Column<string>(nullable: false),
                    TimeOfAvailability = table.Column<string>(nullable: false),
                    RegisteredHospitalId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HospitalsAdmin", x => x.HospitalId);
                    table.ForeignKey(
                        name: "FK_HospitalsAdmin_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HospitalsAdmin_ApplicationUserId",
                table: "HospitalsAdmin",
                column: "ApplicationUserId");
